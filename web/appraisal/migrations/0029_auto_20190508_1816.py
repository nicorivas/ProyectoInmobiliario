...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('appraisal', '0028_auto_20190502_1749'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='tipoTasacion',
            field=models.IntegerField(blank=True, choices=[('', '---------'), (1, 'Hipotecaria'), (21, 'Convenio hipotecario'), (8, 'Garantía general'), (9, 'Pre-informe'), (11, 'Evaluación proyecto inmobiliario'), (12, 'Evaluación proyecto autoconstrucción'), (6, 'Avance de obra inmobiliario'), (10, 'Avance de obra autoconstrucción'), (20, 'Retasación garantía general'), (13, 'Final inmobiliaria'), (14, 'Final autoconstrucción'), (15, 'Remate'), (16, 'Agrícola'), (17, 'Vehículo'), (18, 'Máquinas y equipos'), (2, 'Revisión'), (19, 'Leasing'), (0, 'Otro')], null=True, verbose_name='Tipo Pedido'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='event',
