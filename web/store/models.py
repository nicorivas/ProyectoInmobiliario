...
class Store(models.Model):
    ...
    building = models.OneToOneField(Building,on_delete=models.CASCADE,null=True,blank=False)

    similar = models.ForeignKey('self', on_delete=models.CASCADE, blank=True, null=True)
    
    addressNumber2 = models.TextField("Tienda",max_length=30,null=True,blank=True)
    ...
    def generic_name(self):
        return "Local comercial "+str(self.addressNumber2)
